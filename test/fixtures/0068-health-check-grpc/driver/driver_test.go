...
// TestBackendIdxFromBody_OK: the GRPCHealthResponder canned data-plane body
...
func TestConstants(t *testing.T) {
	...
	if refContainerListenerPort != 19157 {
		t.Errorf("refContainerListenerPort=%d, want 19157 (must be distinct from 0067's 19156)", refContainerListenerPort)
	}
}
