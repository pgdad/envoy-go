...
**Commits:** `adb1d82` — `phase 12: fixture 0014 expectations narrative + README (6 scenarios; shared-stats per §11.9)`; `TBD` — `phase 12 Task 10 follow-up: PROGRESS.md SHA-fill (TBD → adb1d82)`
...
**Commits:** `3a2394f` — `phase 12: fixture 0014 driver — single-listener 6-scenario orchestration + :authority H1/H2 inject`; `TBD` — `phase 12 Task 11 follow-up: PROGRESS.md SHA-fill (TBD → 3a2394f)`
