...
- **last-commit:** `<TBD — SHA-fill follow-up after squash-merge>` (this placeholder is backfilled by the post-`wt-merge` SHA-fill follow-up per the phase-09..22 IMPL-stage close pattern; branch tip at this Task 12 commit is `9a57fdf` + this new commit).
