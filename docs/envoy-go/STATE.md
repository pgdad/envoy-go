...
- **last-commit:** `FILLED-AT-SQUASH` — `phase 28.1b PLAN: 10-task TDD decomposition — ADR-0045 final gate NO SPLIT; D-S28.1b-1 resolved (int64); D-S28.1b-2 resolved (net.Pipe unit race test); plan-document-reviewer approved [ADR-0221,ADR-0222]`. Substantive predecessor on master: the 28.1b-SPEC squash `baf02ed`.
